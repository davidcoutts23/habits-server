...
RSpec.describe 'ApplicationIntentions', type: :request do
  ...
  describe 'GET /application_intentions' do
    before { get '/api/v1/application_intentions' }
  ...
  describe 'POST /application_intention/:id' do
    ...
    context 'when request attributes are valid' do
      before { post '/api/v1/application_intentions', params: valid_attributes }
      it 'returns status code 201' do
        expect(response).to have_http_status(201)
      end
    end
    context 'when an invalid request' do
      before { post '/api/v1/application_intentions', params: {} }
